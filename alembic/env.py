...
from recruitair.database.models import Base  # Import your models here
...
config.set_main_option("sqlalchemy.url", database_url.__to_string__(hide_password=False))
