...
UPDATE_CRITERION_REQUESTS_TIME = Summary(
    "update_criterion_requests_time_seconds", "Time spent processing update criterion requests"
)
UPDATE_CRITERION_DESCRIPTION_LENGTH = Summary(
    "update_criterion_description_length", "Length of updated criterion descriptions in API"
)
UPDATE_CRITERION_IMPORTANCE = Summary("update_criterion_importance", "Importance of updated criteria in API")
