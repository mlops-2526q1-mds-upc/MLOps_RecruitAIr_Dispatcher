...
CREATE_APPLICANTS_REQUESTS_TIME = Summary(
...
APPLICANTS_CREATED_PER_REQUEST = Summary(
    "applicants_created_per_request", "Number of applicants created per create applicants request"
)
APPLICANT_CV_LENGTH = Summary("applicant_cv_length", "Length of applicant CVs")
